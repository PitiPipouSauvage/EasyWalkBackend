<?php
require_once "databaseDatabaseConnexion.php";
...
class databaseConnexion {
    ...
    private function __construct() {
        ...
        $pdo = new PDO("mysql:host=$config[nomHote];port=$config[portBaseDeDonnees];dbname=$config[nomBaseDeDonnees]",
            $config["login"], $config["motDePasse"], array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
        $this->pdo = $pdo;
